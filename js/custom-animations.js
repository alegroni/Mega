(function ($)
{
    ...
    if ($('#sec-mega .animate').length > 0) {
        $('#sec-mega .animate').waypoint(function () {
    ...
    if ($('#sec-desafio .animate').length > 0) {
        $('#sec-desafio .animate').waypoint(function () {
    ...
    if ($('#sec-bases .animate').length > 0) {
        $('#sec-bases .animate').waypoint(function () {
    ...
    if ($('#sec-premios .animate').length > 0) {
        $('#sec-premios .animate').waypoint(function () {
            $('#sec-premios .select-premios.animate.delay-a').addClass('fadeInDown');
    ...
    if ($('#html-mega .animate').length > 0) {
        $('#html-mega .animate').waypoint(function () {
